...
.. admonition:: Task Description
   ...
   Short hidden object memory: observe which cup hides the ball, wait, and touch that cup.

.. image:: ../_static/videos/shell_game_touch.gif
   :alt: Render preview for Shell Game Touch
   :width: 720px
   :align: center
...
- Module: ``mikasa_robo_suite.vla.memory_envs.shell_game_touch_vla``
- Source file: ``mikasa_robo_suite/vla/memory_envs/shell_game_touch_vla.py``

Difficulty and Parameters
-------------------------

Base hidden-object selection variant.
