...
.. admonition:: Task Description
   ...
   Spatial transformation: rotate a peg while keeping its center close to the original position.

.. image:: ../_static/videos/rotate_strict.gif
   :alt: Render preview for Rotate Strict
   :width: 720px
   :align: center
...
- Module: ``mikasa_robo_suite.vla.memory_envs.rotate_strict_vla``
- Source file: ``mikasa_robo_suite/vla/memory_envs/rotate_strict_vla.py``

Difficulty and Parameters
-------------------------

Strict variants have tighter spatial constraints than lenient variants.
