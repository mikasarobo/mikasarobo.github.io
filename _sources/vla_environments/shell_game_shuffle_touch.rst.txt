...
.. admonition:: Task Description
   ...
   Hidden object tracking: track the ball-hiding cup through shuffles and touch it.

.. image:: ../_static/videos/shell_game_shuffle_touch.gif
   :alt: Render preview for Shell Game Shuffle Touch
   :width: 720px
   :align: center
...
- Module: ``mikasa_robo_suite.vla.memory_envs.shell_game_shuffle_touch_vla``
- Source file: ``mikasa_robo_suite/vla/memory_envs/shell_game_shuffle_touch_vla.py``
...
.. code-block:: bash
   ...
   uv run python mikasa_robo_suite/vla/dataset_collectors/get_mikasa_robo_datasets.py \
     --env-id ShellGameShuffleTouch-VLA-v0 \
...
.. code-block:: bash
   ...
   uv run python mikasa_robo_suite/vla/dataset_collectors/get_mikasa_robo_datasets_motion_planning.py \
     --env-id ShellGameShuffleTouch-Long-VLA-v0 \
     --path-to-save-data data_mikasa_robo \
     --num-train-data 250 \
     --max-attempts 5000 \
     --seed 0
...
.. code-block:: bash
   ...
   uv run python utils/prepare_benchmark_demo_videos.py \
     --tasks ShellGameShuffleTouch-VLA-v0 \
