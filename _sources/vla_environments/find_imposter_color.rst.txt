...
.. admonition:: Task Description
   ...
   Out-of-set color detection: remember shown colors and touch the cube whose color was absent from the cue.

.. image:: ../_static/videos/find_imposter_color.gif
   :alt: Render preview for Find Imposter Color
   :width: 720px
   :align: center
...
- Module: ``mikasa_robo_suite.vla.memory_envs.find_imposter_color_vla``
- Source file: ``mikasa_robo_suite/vla/memory_envs/find_imposter_color_vla.py``

Difficulty and Parameters
-------------------------

More colors increase set-comparison difficulty.
...
.. code-block:: bash
   ...
   uv run python mikasa_robo_suite/vla/dataset_collectors/get_mikasa_robo_datasets.py \
     --env-id FindImposterColor3-VLA-v0 \
...
.. code-block:: bash
   ...
   uv run python utils/prepare_benchmark_demo_videos.py \
     --tasks FindImposterColor3-VLA-v0 \
