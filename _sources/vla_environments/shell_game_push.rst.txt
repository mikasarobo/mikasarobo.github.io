...
.. admonition:: Task Description
   ...
   Hidden object selection: remember which cup hides the ball and push that cup forward.

.. image:: ../_static/videos/shell_game_push.gif
   :alt: Render preview for Shell Game Push
   :width: 720px
   :align: center
...
- Module: ``mikasa_robo_suite.vla.memory_envs.shell_game_push_vla``
- Source file: ``mikasa_robo_suite/vla/memory_envs/shell_game_push_vla.py``

Difficulty and Parameters
-------------------------

Short hidden-object memory with directional manipulation.
